...
cd "$BASE_DIR/Structure_en_application_distribuée/plant_shop_java_spring_hibernate_distribuée" || exit 1
...
cd "$BASE_DIR/Structure_en_application_distribuée/plant_shop_java_spring_distribuée" || exit 1
...
cd "$BASE_DIR/Structure_en_micro_services/plant_shop_java_spring_hibernate_microservices" || exit 1
...
cd "$BASE_DIR/Structure_en_micro_services/plant_shop_java_spring_microservices" || exit 1
