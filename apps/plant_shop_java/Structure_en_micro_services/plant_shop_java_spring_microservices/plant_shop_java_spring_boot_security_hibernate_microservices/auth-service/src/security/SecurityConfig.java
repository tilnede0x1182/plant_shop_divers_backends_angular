...
@EnableWebSecurity
/**
 * Configuration Spring Security pour l'auth-service.
 */
public class SecurityConfig {
    ...
    /**
     * Bean pour le service UserDetails (vide, non utilise).
     *
     * @return Service en memoire vide
     */
    @Bean
