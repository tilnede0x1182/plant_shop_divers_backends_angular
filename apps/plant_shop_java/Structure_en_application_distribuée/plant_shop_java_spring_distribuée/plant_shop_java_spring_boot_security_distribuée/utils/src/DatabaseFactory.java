...
/**
 * Fournit un DataSource Hikari (pool) commun à tous les services distribués et
 * expose une connexion par requête HTTP (request scope) pour respecter DRY.
 */
@Configuration
public class DatabaseFactory {
    ...
    public DataSource dataSource() {
        ...
        config.setPoolName("plant-shop-spring-distribuee");
