...
public final class Test {
	 ...
	 * @param host String Hôte à contacter
	 * @param port int Port à tester
	 * @param timeoutMs int Timeout en millisecondes
	 * @return boolean true si le serveur répond
	 */
	...
	/**
	 * Effectue un appel HTTP et retourne un JSONObject.
	...
	/**
	 * Effectue un appel HTTP et retourne un JSONArray.
	 * @param m String Méthode HTTP
	 * @param p String Chemin de l'API
	 * @param exp int Code HTTP attendu
	 * @param body JSONObject Corps de la requête
	 * @param who String Identifiant de session
	 * @return JSONArray Réponse JSON array
	 */
	...
	/* -------- Assertions -------- */
	/**
	 * Vérifie qu'une clé JSON a la valeur attendue.
	 * @param o JSONObject Objet à vérifier
	...
	/**
	 * Vérifie qu'une clé JSON contient un nombre.
	 * @param o JSONObject Objet à vérifier
	 * @param k String Clé à vérifier
	 */
	...
	/**
	 * Test du module plants (CRUD admin).
	 */
	...
	/**
	 * Test du module users (CRUD admin).
	 */
	...
	/**
	 * Test du module orders et order items.
	 */
	 ...
	 * @param email String Email de l'utilisateur à tester
	 */
	...
	/**
	 * Test des opérations admin sur les plantes.
	 */
	...
	/**
	 * Test des opérations admin sur les utilisateurs.
	 */
